...
class TestMemoryPipeline(unittest.TestCase):
    ...
    def test_full_pipeline(self):
        ...
        test_metadata = [
            ...
            {"user_id": "user2", "importance": "medium", "category": "machine_learning"},
        ...
        self.assertEqual(metadata_results[0]["metadata"]["category"], "machine_learning")
    ...
    def test_pipeline_with_different_vector_dbs(self):
        ...
        test_db_types = ["faiss"]  # We could add "qdrant", "milvus", "chroma" if available
        ...
        for db_type in test_db_types:
            with self.subTest(db_type=db_type):
                ...
                metadata_path = os.path.join(temp_dir.name, f"test_{db_type}_metadata.json")
