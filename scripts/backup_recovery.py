...
def main():
    ...
    parser.add_argument("--config", type=str, default="config/backup_config.json", help="Path to backup configuration file")
    parser.add_argument("--action", type=str, required=True, choices=["backup", "restore", "list"], help="Action to perform")
    parser.add_argument("--db-type", type=str, choices=["postgresql", "qdrant", "milvus", "chroma", "all"], help="Database type to backup/restore")
    parser.add_argument("--backup-path", type=str, help="Path to backup file/directory for restore")
