...
class ContextManager:
    ...
    def prepare_context_for_llm(self, conversation_history: List[Dict[str, Any]], token_limit: int = 1024) -> str:
        """
        ...
        if estimated_tokens > token_limit:
            logger.info(f"Context exceeds token limit ({estimated_tokens} > {token_limit}), summarizing")
