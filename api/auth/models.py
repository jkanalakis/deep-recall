...
class Role(BaseModel):
    ...
    permissions: List[str] = Field(default_factory=list, description="List of permission scopes granted by this role")
...
class User(BaseModel):
    ...
    disabled: bool = False
    roles: List[str] = Field(default_factory=list, description="List of role IDs assigned to this user")
