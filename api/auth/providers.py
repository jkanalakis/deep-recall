...
JWT_SECRET = os.getenv("JWT_SECRET", "development_secret_key")  # Use env vars in production
...
class JWTAuth:
    ...
    @staticmethod
    def refresh_access_token(refresh_token: str, user_db: Dict[str, User]) -> Optional[Tuple[str, int]]:
        """
...
class APIKeyAuth:
    ...
    @staticmethod
    def verify_api_key(api_key: str, api_keys_db: Dict[str, Dict[str, Any]]) -> Optional[str]:
        """
...
async def get_current_user(
    ...
    if user_db is None:
        ...
        mock_user = UserCreate(username="demo", email="demo@example.com", password="Demo1234", full_name="Demo User")
        user_db = {
            "user123": User.create(mock_user)
        }
