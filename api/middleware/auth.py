...
JWT_SECRET = os.getenv("JWT_SECRET", "development_secret_key")  # In production use env vars
JWT_ALGORITHM = "HS256"
...
async def authenticate_request(credentials: HTTPAuthorizationCredentials = Security(security)) -> TokenData:
    """
...
def check_scope(required_scope: str, token_data: TokenData = Depends(authenticate_request)) -> TokenData:
    """
