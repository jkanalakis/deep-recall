...
class DeepRecallDB:
    ...
    def get_memories_by_semantic_search(
        ...
        with self.conn.cursor() as cur:
            ...
            logger.info(
                f"Retrieved {len(memories)} memories for user {user_id} matching query: {query[:50]}..."
            )
    ...
    def store_interaction(
        ...
        with self.conn.cursor() as cur:
            ...
            if memory_ids and interaction:
                ...
                memory_data = [
                    (memory_id, interaction_id, relevance_score)
    ...
    with DeepRecallDB() as db:
        ...
        if users:
            ...
            similar_memories = db.get_memories_by_semantic_search(
                user_id=user_id, query="Tell me about test memories", k=5
            )
